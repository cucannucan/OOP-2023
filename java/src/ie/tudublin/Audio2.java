...
public class Audio2 extends PApplet{
    ...
    public class PitchSpeller {
        ...
        private String[] spellings = {"D,", "E,", "F,", "G,", "A,", "B,", "C", "D", "E", "F", "G", "A", "B",
                                      "c", "d", "e", "f", "g", "a", "b", "c'", "d'", "e'", "f'", "g'", "a'", "b'", "c''", "d''"};
    
        public String spell(float frequency) {
            int index = 0;
            float minDifference = Math.abs(frequency - frequencies[0]);
    
            // find the frequency with the minimum difference
            for (int i = 1; i < frequencies.length; i++) {
                float difference = Math.abs(frequency - frequencies[i]);
